<div class="grid grid-cols-2 gap-2">
    ...
    <div class="mb-4">
        ...
        <x-text-input  id="localidade" name="localidade" type="text" class="mt-1 block w-full" :value="$entity->localidade ?? old('localidade')"/>

        <x-input-error :messages="$errors->get('localidade')" class="mt-1" />
    </div>
