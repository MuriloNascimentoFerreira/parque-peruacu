<!-- Main modal -->
<div id="visualizar-condutor-{{$entity->id}}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="visualizar-condutor-{{$entity->id}}">
            ...
            <div class="p-4 md:p-5 space-y-2">
                ...
                <div><strong>Roteiros: </strong>{{$entity->getRoteirosNomes()}}</div>
            </div>
        </div>
    </div>
</div>
