<div class="grid grid-cols-12 gap-2">
    ...
    <div class="mb-4 col-span-3">
        <div class="relative">
            <x-input-label for="data" :value="__('Data')" :required="true"/>
    ...
    <div class="mb-4 col-span-3">
        <x-input-label for="quantidadePessoas" :value="__('Quantidade pessoas')" :required="true"/>
    ...
    <div class="mb-4 col-span-3">
        <x-input-label for="quantidadePessoasEfetivo" :value="__('Quantidade condutores')"/>
        <x-text-input  readonly id="quantidade-pessoas-efetivo" name="quantidadePessoasEfetivo" type="number" class="mt-1 block w-full inteiro no-edit" :value="$entity->quantidadePessoasEfetivo ?? null"/>
    ...
    <input type="hidden"  id="visitantesPorCondutor" name='visitantesPorCondutor' value="{{$visitantesPorCondutor}}">
