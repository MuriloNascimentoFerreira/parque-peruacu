<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <x-input-error :messages="$errors->get('messages.passwordIncorrect')" class="mt-2" />
        </div>
        ...
        {{-- Botão para acessar login visitante --}}
        <div class="flex items-center justify-start mt-4">
            @if (Route::has('magic-login-create'))
