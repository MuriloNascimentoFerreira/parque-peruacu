<div class="grid grid-cols-2 gap-6">
    ...
    <div>
        <x-input-label for="lotacao" :value="__('Lotação')" :required="true"/>
    ...
    <div>
        <x-input-label for="duracao" :value="__('Duração')" :required="true"/>
    ...
    <div>
        <x-input-label for="nivel" :value="__('Nível')" :required="true"/>
    ...
    <div>
        <x-input-label for="distancia" :value="__('Distância')" :required="true"/>
        <div class="relative">
